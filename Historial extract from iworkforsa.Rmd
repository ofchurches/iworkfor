...
So, the Department of Health and Wellbeing has the greatest number of "data" job advertisements: `r dhw_count`. But, it also has the fourth smallest proportion of data job advertisments: `r dhw_percent`%.
